...
from forum.sitemap import OsqaSitemap, CasesSitemap, TermsSitemap, MiscSitemap
...
core_urls = (
    ...
    #url(r'^%s(.*)' % _('admin/'), admin.site.urls),
    ...
    url(r'^%s$' % _('dashboard/'), app.readers.dashboard, name='dashboard'),
    url(r'^%s$' % _('questions/'), app.readers.questions, name='questions'),
    url(r'^(?P<type>\w+)/%s$' % _('questions/'), app.readers.questions, name='questions'),
    url(r'^%s$' % _('terms/'), app.readers.terms, name='terms'),
    url(r'^%s$' % _('cases/'), app.readers.cases, name='cases'),
    url(r'^%s$' % _('articles/'), app.readers.articles, name='articles'),
    url(r'^%s%s$' % (_('questions/'), _('ask/')), app.writers.ask, name='ask'),
    url(r'^%s%s$' % (_('cases/'), _('add_case/')), app.writers.add_case, name='add_case'),
    url(r'^%s%s$' % (_('articles/'), _('add_article/')), app.writers.add_article, name='add_article'),
    ...
    #url(r'^%s%s(?P<title>\w+)/(?P<url>\w+)/$' % (_('books/'), _('add/')), app.writers.add_book, name='add_book'),        
    url(r'^%s%s$' % (_('books/'), _('add/')), app.writers.add_book, name='add_book'),
    url(r'^%s%s$' % (_('terms/'), _('add/')), app.writers.add_term, name='add_term'),
    url(r'^%s%s(?P<key>\w+)$' % (_('questions/'), _('get/')), app.readers.get_questions, name='get_questions'),
    url(r'^%s%s(?P<key>\w+)$' % (_('terms/'), _('get/')), app.readers.get_terms, name='get_terms'),
    url(r'^%s%s$' % (_('terms/'), _('search')), app.readers.search_terms, name='search_terms'),
    url(r'^%s%s(?P<k>\w+)$' % (_('books/'), _('clear/')), app.writers.clear_books, name='clear_books'),
    url(r'^%s%s(?P<k>\w+)$' % (_('terms/'), _('clean/')), app.writers.clean_terms, name='clean_terms'),
    url(r'^%s(?P<id>\d+)/%s$' % (_('questions/'), _('edit/')), app.writers.edit_question, name='edit_question'),
    url(r'^%s(?P<id>\d+)/%s$' % (_('cases/'), _('edit/')), app.writers.edit_case, name='edit_case'),
    ...
    url(r'^%s(?P<id>\d+)/' % _('approve/'), app.commands.approve_post, name='approve_post'),
    ...
    url(r'^%s(?P<id>\d+)/?$' % _('cases/'), app.readers.case, name='case'),
    url(r'^%s(?P<id>\d+)/?$' % _('articles/'), app.readers.article, name='article'),
    ...
    url(r'^%s(?P<id>\d+)/(?P<slug>.*)$' % _('cases/'), app.readers.case, name='case'),
    url(r'^%s(?P<id>\d+)/(?P<slug>.*)$' % _('articles/'), app.readers.article, name='article'),
    url(r'^%s(?P<id>\d+)/(?P<slug>.*)$' % _('terms/'), app.readers.term, name='term'),
    ...
    url(r'^%s$' % _('library/'), app.meta.library, name='library'),
    url(r'^%s(?P<view>\w+)$' % _('library/'), app.meta.library, name='library'),
    url(r'^%s$' % _('badges/'), app.meta.badges, name='badges'),
    url(r'^%s(?P<id>\d+)/(?P<slug>[\w-]+)?$' % _('badges/'), app.meta.badges, name='badges'),
